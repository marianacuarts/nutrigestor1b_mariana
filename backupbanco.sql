...
\restrict BJu6FwGXDSOeDqginnBmd4mdigrR91FjTDevgDUknt8lMifTHfeAsH8qm7tXoUc
...
1	2026-06-23	feijão com farinha	feijão com farinha
2	2026-06-24	Estrogonof	batata palha, arroz, frango
3	2025-06-25	Arroz temperado	arroz, tempero, legumes
\.
...
--
-- Name: participacao pk_restricao; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.participacao
    ADD CONSTRAINT pk_restricao PRIMARY KEY (id_aluno, id_cardapio, dt_merenda);
...
--
-- Name: item_restricao fk_ri_estoque; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.item_restricao
    ADD CONSTRAINT fk_ri_estoque FOREIGN KEY (id_estoque) REFERENCES public.estoque(id) ON DELETE CASCADE;
...
\unrestrict BJu6FwGXDSOeDqginnBmd4mdigrR91FjTDevgDUknt8lMifTHfeAsH8qm7tXoUc
